...
function default_paths()
    ...
    forcing  = joinpath(base_dir, "data", "input", "forcing_drammen_n2.nc")
...
#    atmosphere = NORA3PrescribedAtmosphere(arch)
    ...
    # Set χ = 0 to disable Adams-Bashforth extrapolation (effectively forward Euler)
    # This helps debug biogeochemical instabilities by removing tendency extrapolation
    ocean_model.timestepper.χ = 0.0
